...
void EPropWnd::SetScrollPage( int nViewWidth , int nViewHeight )
{
	CSize PageSize = GetScrollPageSize( nViewWidth , nViewHeight );
...
void EPropWnd::SetActiveProperty( EProperty* pNewActiveProperty )
{
	if( pNewActiveProperty != m_pActiveProperty )
	{
		...
		if( m_pCommentPane != NULL )
		{
			if( m_pActiveProperty != NULL )
			{
				m_pCommentPane->SetComment( m_pActiveProperty->GetComment() );
			}
		}
...
CSize EPropWnd::GetScrollPageSize( int nViewWidth , int nViewHeight )
{
