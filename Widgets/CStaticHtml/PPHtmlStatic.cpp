...
void CPPHtmlStatic::SetFont(LPCTSTR szFont, int nPointSize,int nWeight)
{
...
void CPPHtmlStatic::Format(LPCTSTR szFmt, ...)
{
	ULONG	bytesWriten;
	TCHAR	szBuffer[2048];
...
void CPPHtmlStatic::AppendText(LPCTSTR szFmt, ...)
{
	ULONG	bytesWriten;
	TCHAR	szBuffer[2048];
	va_list args;
